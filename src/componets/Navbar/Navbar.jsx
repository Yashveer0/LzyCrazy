    ...
    <nav className="bg-white  fixed top-0 w-full z-50">
      <div className="max-w-6xl ml-2 px-4">
        <div className="flex justify-between items-center py-4">
          ...
          {/* Navbar Links */}
          <div className={`md:flex items-center justify-end w-full ${isOpen ? 'block' : 'hidden'} space-x-[6rem] w-full md:w-auto`}>
            ...
            <ul className={`flex ${isOpen ? "space-y-6" : "md:space-x-6"} flex-col   md:flex-row md:space-x-6 text-gray-800 mt-4 md:mt-0`}>
              <li className="flex flex-col items-center font-bold">
